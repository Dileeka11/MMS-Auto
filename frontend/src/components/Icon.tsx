...
export function Icon({ n, s = 18, c = 'currentColor', sw = 1.75, style }: IconProps) {
  ...
  const paths: Record<string, ReactNode> = {
    ...
    'eye-off': <><path d="M17.94 17.94A10.94 10.94 0 0 1 12 19c-6 0-10-7-10-7a18.5 18.5 0 0 1 4.22-5.06" /><path d="M9.9 4.24A10.94 10.94 0 0 1 12 4c6 0 10 7 10 7a18.5 18.5 0 0 1-3.17 4.19" /><path d="M9.88 9.88a3 3 0 0 0 4.24 4.24" /><path d="M3 3l18 18" /></>,
